...
function initSwiper(initialSlide) {
    if (!swiperInstance) swiperInstance = new (0, _swiperDefault.default)(".fullscreenSwiper", {
    ...
    else swiperInstance.slideTo(initialSlide, 0);
...
fullscreenSwiper.addEventListener("click", function(e) {
    if (e.target == fullscreenSwiper) fullscreenSwiper.style.display = "none";
});
...
},{"swiper":"iM6UL","swiper/swiper-bundle.css":"aErfw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 11.1.14
...
},{"./ssr-window.esm.mjs":"th8PY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aErfw":[function() {},{}]},["2L15i","dV6cC"], "dV6cC", "parcelRequire3e81")
